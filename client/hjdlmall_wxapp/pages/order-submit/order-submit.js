...
Page({
    ...
    orderSubmit: function(t) {
        ...
        if (1 == s.is_form && a.data.goods_list && a.data.goods_list.length) {
            var o = s.list;
            for (var r in o) if ("date" == o[r].type && (o[r].default = o[r].default ? o[r].default : a.data.time), 
            "time" == o[r].type && (o[r].default = o[r].default ? o[r].default : "00:00"), 1 == o[r].required) if ("radio" == o[r].type || "checkboxc" == o[r].type) {
                var d = !1;
                for (var n in o[r].default_list) 1 == o[r].default_list[n].is_selected && (d = !0);
                if (!d) return getApp().core.showModal({
                    title: "提示",
                    content: "请填写" + s.name + "，加‘*’为必填项",
                    showCancel: !1
                }), !1;
            } else if (!o[r].default || void 0 == o[r].default) return getApp().core.showModal({
                title: "提示",
                content: "请填写" + s.name + "，加‘*’为必填项",
                showCancel: !1
            }), !1;
        }
        if (a.data.pond_id > 0 || a.data.scratch_id > 0 || a.data.lottery_id > 0) {
        ...
        a.data.mch_list && a.data.mch_list.length) {
            ...
            for (var r in a.data.mch_list) if (a.data.mch_list[r].cart_id_list) {
                ...
                a.data.mch_list[r].content && (p.content = a.data.mch_list[r].content), c.push(p);
            }
        ...
        i.scratch_id = a.data.scratch_id, i.lottery_id = a.data.lottery_id, i.pond_id ? a.order_submit(i, "pond") : i.scratch_id ? a.order_submit(i, "scratch") : i.lottery_id ? a.order_submit(i, "lottery") : a.order_submit(i, "s");
    },
    onReady: function() {},
    onShow: function(t) {
    ...
    getOrderData: function(e) {
        ...
        if (e.cart_id_list) {
            var r = JSON.parse(e.cart_id_list);
            s.cart_id_list = r;
        }
        if (e.mch_list) {
            var d = JSON.parse(e.mch_list);
            s.mch_list = d;
        }
        ...
        getApp().request({
            ...
            success: function(t) {
                if (getApp().core.hideLoading(), 0 == t.code) {
                    ...
                    var r = t.data.shop_list, d = {};
                    r && 1 == r.length && (d = r[0]), t.data.is_shop && (d = t.data.is_shop), a || ((a = {
                        shop: d,
                    ...
                    a.coupon_list = s, a.shop_list = r, a.send_type = t.data.send_type, a.level = t.data.level, 
    ...
    getPrice: function() {
        var t = this, a = t.data.total_price, e = t.data.express_price, i = t.data.picker_coupon, s = t.data.integral, o = t.data.integral_radio, r = t.data.level, d = t.data.offline;
        if (t.data.goods_list && t.data.goods_list.length > 0 && (i && (a -= i.sub_price), 
        s && 1 == o && (a -= parseFloat(s.forehead)), r && (a = a * r.discount / 10), a <= .01 && (a = .01), 
        0 == d && (a += e)), t.data.mch_list && t.data.mch_list.length) for (var n in t.data.mch_list) a += t.data.mch_list[n].total_price + t.data.mch_list[n].express_price;
        t.setData({
    ...
    selectForm: function(t) {
        ...
        if ("radio" == o[e].type) {
            ...
            for (var d in r) d == i ? r[i].is_selected = 1 : r[d].is_selected = 0;
            o[e].default_list = r;
        }
