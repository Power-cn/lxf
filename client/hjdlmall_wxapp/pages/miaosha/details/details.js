var t = require("../../../utils/helper.js"), a = require("../../../wxParse/wxParse.js"), e = require("../../../components/goods/goods_banner.js"), o = require("../../../components/goods/specifications_model.js"), i = require("../../../components/goods/goods_info.js"), s = require("../../../components/goods/goods_buy.js"), n = require("../../../components/quick-navigation/quick-navigation.js"), r = 1, d = !1, c = !0, p = 0;
...
Page({
    ...
    onLoad: function(a) {
        getApp().page.onLoad(this, a), p = 0, r = 1, d = !1, c = !0;
        ...
        e.scene_type = t.data.scene_type, getApp().request({
            ...
            success: function(e) {
                if (0 == e.code) {
                    ...
                    var i = e.data, s = e.data.miaosha, n = [];
                    for (var r in i.pic_list) n.push(i.pic_list[r].pic_url);
                    i.pic_list = n, i.min_price = s.new_small_price, i.sales_volume = s.sell_num, t.setData({
                        goods: i,
    ...
    getCommentList: function(t) {
        var a = this;
        t && "active" != a.data.tab_comment || d || c && (d = !0, getApp().request({
