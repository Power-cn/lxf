var t = require("../../../utils/helper.js"), e = require("../../../wxParse/wxParse.js"), a = require("../../../components/goods/specifications_model.js"), o = require("../../../components/goods/goods_banner.js"), i = require("../../../components/goods/goods_info.js"), s = require("../../../components/goods/goods_buy.js"), n = require("../../../components/quick-navigation/quick-navigation.js"), r = 1, d = !1, c = !0;
...
Page({
    ...
    onLoad: function(e) {
        ...
        this.setData({
            id: e.id
        }), r = 1, this.getGoodsInfo(e), this.getCommentList(!1);
    },
    onReady: function(t) {
    ...
    getCommentList: function(t) {
        var e = this;
        t && "active" != e.data.tab_comment || d || c && (d = !0, getApp().request({
